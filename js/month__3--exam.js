...
const elAction = document.querySelector(".action");
const elComedy = document.querySelector(".comedy");
const elFantasy = document.querySelector(".fantasy");
const elAdventure = document.querySelector(".adventure");
const elScience = document.querySelector(".science");
const elThriller = document.querySelector(".thriller");
const elHorror = document.querySelector(".horror");
const elAnimation = document.querySelector(".animation");
const elFamily = document.querySelector(".family");
const elDocumentary = document.querySelector(".documentary");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  <p>Category: ${item.genres}</p>
       </li>`;
      }
    });
    displayMenu = displayMenu.join("");
    elList.innerHTML = displayMenu;
  });
  ...
  elAll.addEventListener("click", function (evt) {
    ...
    let displayMenu = menu.map(function (item) {
      return `
      <li class = "item__list"> <img src = ${item.poster}> 
      <h2 class="mt-5">${item.title}</h2>
      <p>Category: ${item.genres}</p>
       </li>`;
    });
...
elSearch.addEventListener("input", () => {
  ...
  let searchArray = menu.filter((item) => {
    if (
